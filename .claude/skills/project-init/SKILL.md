...
4. **Create the Blueprint:** Fill out `blueprint-template.md` (bundled in this skill directory) with all 9 sections. Include version numbers, source URLs, and rationale for each choice.
